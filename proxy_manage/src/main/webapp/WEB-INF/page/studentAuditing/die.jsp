...
<script type="text/javascript">
	...
	function init(){
		$('#listData').datagrid({
        	url: 'unaudited/list?id=4',//请求方法的地址
       		title: '查询结果',
        	height: 500, 
        	...
        	columns: [[
    				...
    				{field:'tuition',title:'应缴学费(￥)',width:80,align:'center',formatter:function(value, row, index){ return row.student.joinTime}},  
	...
	function search(){
		...
		$('#listData').datagrid({"url":"unaudited/list?id=4&"+date});
	}
	
	
	function clean(){
	$('#searchForm').form('clear');
	$('#listData').datagrid({'url':'unaudited/list?id=4'});
	}
...
<div id="checkWin" class="easyui-window"  closed="true" style="height:500px;width:600px">
	  <form id="checkForm" action="">
		...
		<div>
			<label>&nbsp;&nbsp;&nbsp;学生姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="studentName" name="studentName" 	 style="border:none;" readonly="readonly"> 
			<label>&nbsp;&nbsp;&nbsp;联系电话：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="studentTel" name="studentTel"  style="border:none;" readonly="readonly"> 
		</div>
		<div>
			<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;班&nbsp;&nbsp;级：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="classroom" name="classroom"  style="border:none;" readonly="readonly">
			<label>&nbsp;&nbsp;&nbsp;招生老师：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="proxyTeacher" name="proxyTeacher"  style="border:none;" readonly="readonly"> 
		</div>
		<div>
			<label>报销人姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="actualObject" name="actualObject"  style="border:none;" readonly="readonly"> 
			<label>报销人电话：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="actualObjectTel" name="actualObjectTel"  style="border:none;" readonly="readonly"> 
		</div>
		<div>
			<label>&nbsp;&nbsp;&nbsp;应缴学费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="yingFee" name="yingFee"  style="border:none;" readonly="readonly">
			<label>&nbsp;&nbsp;&nbsp;实缴学费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="shiFee" name="shiFee"  style="border:none;" readonly="readonly"> 
		</div>
		<div>
			<label>&nbsp;&nbsp;&nbsp;应报金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="yingAmount" name="yingAmount"  style="border:none;" readonly="readonly">
			<label>&nbsp;&nbsp;&nbsp;实报金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="shiAmount" name="shiAmount"  style="border:none;" readonly="readonly"> 
		</div>
		<div>
