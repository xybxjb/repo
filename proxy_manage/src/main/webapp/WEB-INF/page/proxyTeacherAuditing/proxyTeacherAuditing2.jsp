...
$(function(){
	...
	function init(){
		$('#listData').datagrid({
	        url: 'proxyTeacherAuditing/haveToSubmit',//请求方法的地址
	        title: '查询结果',
	        ...
	        columns: [[
	            ...
	            {
	                field: 'purpose', title: '来访目的', width: 40, align: 'center'
	            },	            
	            {
	            	field: 'auditState', title:'状态',align: 'center',width: 50 /* ,formatter:function(value,row,index){
	...
	function opt(value,row,index){
		 var str = "";
		    str += '<a href="javascript:void(0);" onclick="xiangqing('+row.id+')">详&nbsp;情</a>';
		    return str;
	}
	...
	function xiangqing(id){
		$.ajax({
			type : "post",//请求方式
			data:{"id":id},
			url : "proxyTeacherAuditing/getBySubmitId",
			async : true,
